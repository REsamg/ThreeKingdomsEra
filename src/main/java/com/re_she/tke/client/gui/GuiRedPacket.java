package com.re_she.tke.client.gui;


import com.re_she.tke.Fmltutor;
import com.re_she.tke.inventory.ContainerRedPacket;
...
public class GuiRedPacket extends GuiContainer {
    ...
    private static final String TEXTURE_PATH = Fmltutor.MODID + ":" + "textures/gui/container/gui_redpacket.png";
    ...
    public void initGui() {
        ...
        wishTextBox = new GuiTextField(Minecraft.getMinecraft().fontRendererObj, this.xSize / 2 - 80, 65, 160, 16);
        wishTextBox.setFocused(true);
        wishTextBox.setMaxStringLength(64);
        wishTextBox.setText(wish);
        sendeeTextBox = new GuiTextField(Minecraft.getMinecraft().fontRendererObj, this.xSize / 2 + 96, 65, 64, 16);
